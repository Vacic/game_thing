...
const Profile = ({ user, setMessage, showMsg, setModal, loggedIn }) => {
    ...
    if (
      ...
      for (const property in newFormData)
        if (
          ...
          newFormData[property] === user[property]
        )
          delete newFormData[property];
  ...
  const resetProg = async () => {
    setModal({
      text: "Are you sure you want to reset your progress? This action is irreversible.",
      func: resetProgress,
      history: history,
      redirectTo: "/",
      redirectDelay: 2000,
      ...
      <div className="profile">
        ...
        <form onSubmit={(e) => onSubmit(e)}>
          ...
          <div className="profile-buttons">
            ...
            <div className="btn danger" onClick={() => resetProg()}>
              Reset Progress
            </div>
            <div className="btn danger" onClick={() => deleteAcc()}>
              Delete Profile
            </div>
          </div>
        </form>
