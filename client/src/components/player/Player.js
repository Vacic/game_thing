...
const Player = (props) => {
    ...
    return (
        <div className="player" ref={playerDiv}>
            <PlayerCard currentHp={currentPlayerHp} maxHp={hp} playerName={playerName} playerHpBar={playerHpBar} playerAttStatus = {playerAttStatus} handleUseItem={handleUseItem} />
