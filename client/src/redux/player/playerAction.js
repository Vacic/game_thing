...
import { UPDATE_PLAYER_EQUIPMENT, UPDATE_PLAYER_STATS, UPDATE_PLAYER_QUICKBAR_EQUIPMENT, UPDATE_USER, UPDATE_INVENTORY, REDUCE_SINGLE_ITEM } from './playerTypes';
const cookies = new Cookies();

export const populatePlayer = ({ playerStats, equipment, quickBarEquipment, inventory }) => async dispatch => {
