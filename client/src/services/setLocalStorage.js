...
export const setLocalStorage = async () => {
    ...
    const localProgress = await localStorage.progress ? JSON.parse(localStorage.getItem('progress')) : {};
    localProgress.playerStats = player.stats;
    localProgress.currentHp = gameData.currentPlayerHp === 0 ? 40 : gameData.currentPlayerHp;
